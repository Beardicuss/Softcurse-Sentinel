  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        const vHref = (v: string, _prod: string) => SITE_VARIANT === v ? '#' : '#';
        ...
        return `
          ...
          <span class="logo">SOFTCURSE SENTINEL</span><span class="logo-mobile">Softcurse Sentinel</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">SOFTCURSE SENTINEL</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">SOFTCURSE SENTINEL</span>
            <span class="site-footer-sub">by Softcurse Lab.</span>
          </div>
        </div>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Softcurse Lab</span>
      </footer>
    `;
