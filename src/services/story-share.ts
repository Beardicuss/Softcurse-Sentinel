...
export const shareTexts = {
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via Softcurse Sentinel - Real-time global intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - Softcurse Sentinel`)}`,
